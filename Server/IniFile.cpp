...
/*************************************************
  ...
  Others:
*************************************************/
int IniFile::OpenFile(const char *pszFilename)
{
    FILE    *fp;
    size_t  len;
    int     result;
...
*************************************************/
unsigned int IniFile::GetItemValue( const char *pszSectionName,
...
/*************************************************
  ...
  Others:       本函数不是UNICODE版本
*************************************************/
unsigned int IniFile::SetItemValue( const char *pszSectionName,
                                   const char *pszKeyName,
                                   int lKeyValue )
{
    char szBuf[100];
...
/*************************************************
  ...
  Others:       本函数不是UNICODE版本
*************************************************/
unsigned int IniFile::LocateSection( const char *pszSectionName,
...
/*************************************************
  ...
  Others:       本函数不是UNICODE版本
*************************************************/
unsigned int IniFile::LocateKeyRange( const char *pszKeyName,
...
/*************************************************
  ...
  Others:       本函数不是UNICODE版本
*************************************************/
unsigned int IniFile::LocateKeyValue( const char *pszKeyName,
                                   const char *pszSectionBegin,
                                   const char *pszSectionEnd,
                                   char * &pszValueBegin,
                                   char * &pszValueEnd )
...
/*************************************************
  ...
  Others:
*************************************************/
char *IniFile::LocateStr( const char *pszCharSet,
                              const char *pszBegin,
                              const char *pszEnd )
{
    char *pFind;
...
char *IniFile::SearchMarchStr(const char *pszBegin, const char *pszCharSet)
{
	char *pFind;
	char *pFind1;
	char *pTempBegin = (char*)pszBegin;
...
/*************************************************
  ...
  Others:
*************************************************/
char *IniFile::MapToContent(const char *p)
{
...
/*************************************************
  ...
  Others:
*************************************************/
char *IniFile::MapToShadow(const char *p)
{
...
/*************************************************
  ...
  Others:
*************************************************/
void IniFile::ToLower( char * pszSrc, size_t len)
{
    BYTE    cb;
    size_t  i;
...
std::string IniFile::ReadString(const char *pszSectionName,
                      const char *pszKeyName,
                      const char *pszDefaultValue)
{
       char valuebuf[1024]={'\0'};
       int ret = GetItemValue(  pszSectionName, pszKeyName, valuebuf, 1024 );
       if(ret == 0 )
...
int IniFile::ReadInt(const char *pszSectionName,
                    const char *pszKeyName,
                    const int pszDefaultValue)
{
      int value;
      int ret = GetItemValue(pszSectionName, pszKeyName, value, pszDefaultValue);
       if(ret == 0 )
